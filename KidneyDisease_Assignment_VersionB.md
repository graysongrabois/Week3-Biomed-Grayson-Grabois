...
- What might extremely high blood urea values indicate clinically?
...
```python
# First, handle any missing bp values if present
# Then create the bp_category column
...
```python
# Calculate the percentage of patients who have CKD in each blood pressure category
...
- [ ] **Part 4:** Created `bp_category` column using the **Blood Pressure Classification**
- [ ] **Part 4:** Calculated CKD rate by blood pressure category with interpretation
- [ ] **Part 5:** Three research questions (blood urea, diabetes, anemia+edema)
- [ ] **Part 5:** One unanswerable question about disease progression/outcomes
- [ ] **Part 5:** Blood urea groupby analysis
...
| Part 4: Blood Pressure Groups | 10 | Working code that creates correct groups AND meaningful interpretation |
